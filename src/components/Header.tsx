...
const Header = () => {
    ...
    return (
        <header
            className={scrolled ? 'px-0 py-4 fixed w-full top-0 transition 0.32s ease-in-out scroll z-10 bg-[#121212]' : 'px-0 py-24 fixed w-full top-0 transition 0.32s ease-in-out z-10'}>
            <Container>
                <div className="flex justify-between items-center">
                    ...
                    <nav className="flex">
                        ...
                        <a className='px-2 py-2 ml-8 border-solid border-2 border-white' href="/#connect">Давайте
                            свяжемся</a>
                    </nav>
                </div>
            </Container>
